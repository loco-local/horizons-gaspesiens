    ...
    <div class="mt-12 pt-12">
        <v-layout row wrap>
            <v-flex xs12 class="text-left pl-6 pt-0 mt-0">
                ...
                <p>
                    1) Un livre peut être disponible sur le réseau des bibliothèques de la Gaspésie, un hyperlien vous mènera à la page du réseau Biblio sur laquelle vous n’aurez qu’à entrer le titre, la cote ou l’auteur du livre.
                </p>
                <p>
                    2) Le livre peut aussi être disponible directement chez une personne dans une municipalité gaspésienne.
                </p>
                <p>
                    Nous tentons l’expérience avec le prêt de livres et qui sait, peut-être un jour pourrons-nous faire de même avec les tondeuses, rotoculteurs et autres biens et services !
                </p>
                <p>
                    Plusieurs livres sont disponibles à la bibliothèque du Loco Local. Celle-ci est maintenant intégrée dans le réseau Biblio, et peuvent donc voyager à travers la Gaspésie si vous souhaitez le réserver.
                </p>
                <p>
